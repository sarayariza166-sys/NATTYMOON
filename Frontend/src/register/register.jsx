...
function Register() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (!formData.nombre || !formData.correo || !formData.contraseña) return alert("Todos los campos son obligatorios");
    if (!formData.aceptarTerminos) return alert("Debes aceptar los términos y condiciones");
    alert("Usuario registrado correctamente");
    setFormData({ nombre: "", correo: "", contraseña: "", aceptarTerminos: false });
    navigate("/login");
  };
